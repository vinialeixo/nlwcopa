...
function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert(
        "Bolão criado com sucesso, codigo foi copiado para a área de transferencia!"
      );
      setPoolTitle("");
    } catch (err) {
      console.log(err);
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center ">
      <main>
        ...
        <p className="mt-4 txt-sm text-gray-300 leading-relaxed">
      ...
      <Image
        src={appPreviewImg}
        alt="dois celulares exibindo como será no mobile"
        quality={100}
      />
    </div>
  );
